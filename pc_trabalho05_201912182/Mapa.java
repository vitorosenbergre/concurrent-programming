...
public class Mapa extends JFrame implements ActionListener{
  ...
  // Combobox dos protocolos
  private String[] protocolosMessege = new String[]{"Bandeiras", "Variavel de Travamento", "Estrita Alternancia", "Peterson"};
  private JComboBox<String> protocolos = new JComboBox<>(protocolosMessege);
  ...
  // botao do selecionar protocolo
  private JButton selecionarProtocolo= new JButton();
  ...
  *************************************************************** */
  ...
  /* ***************************************************************
  * Metodo: AdicionarComboBox.
  * Funcao: Adicionar o combobox e o botao no panel.
  * Parametros: nao tem parametro.
  * Retorno: nao retorna nada, pois eh um void.
  *************************************************************** */
  public void AdicionarComboBox(){
    protocolos.addActionListener(this);
    protocolos.setBounds(475, 230, 140, 20);
    panel.add(protocolos);

    selecionarProtocolo.setText("Start");
    selecionarProtocolo.addActionListener(this);
    selecionarProtocolo.setBounds(490,200, 110, 20);
    selecionarProtocolo.setFont(new Font("Serif", Font.BOLD,14));
    panel.add(selecionarProtocolo);
  } // final do metodo AdicionarComboBox
  ...
  *************************************************************** */
  ...
  public void actionPerformed(ActionEvent evento){
    try{
     ...
     //quanto o evento for igual ao botao de "Start", vai selecionar o atual item da combobox e iniciar
     // o protocolo selecionado
     if(evento.getSource()== selecionarProtocolo){
       String prot = (String) protocolos.getSelectedItem();
       switch(prot){
        case"Bandeiras":
        Trem1.setProtocolo("bandeiras");
        Trem2.setProtocolo("bandeiras");
        Trem1.setControladorProtocolo(1); // controlador que eu fiz pra acessar o reset do protocolo 1 vez por escolha
        Trem2.setControladorProtocolo(1); 
        bandeira.setVisible(true);
        bandeira2.setVisible(true);
        bandeira3.setVisible(true);
        bandeira4.setVisible(true);
        break;
      case"Variavel de Travamento":
        Trem1.setProtocolo("travamento");
        Trem2.setProtocolo("travamento");
        Trem1.setControladorProtocolo(1);
        Trem2.setControladorProtocolo(1);
        bandeira.setVisible(true);
        bandeira2.setVisible(true);
        bandeira3.setVisible(true);
      ...
      case"Estrita Alternancia":
        // foi tirada as bandeiras da estrita alternancia, pois eles nao precisam mais olhar as bandeiras para acessar a RC
        Trem1.setProtocolo("estrita");
        Trem2.setProtocolo("estrita");
        Trem1.setControladorProtocolo(1);
        Trem2.setControladorProtocolo(1);
        bandeira.setVisible(false);
        bandeira2.setVisible(false);
        bandeira3.setVisible(false);
        bandeira4.setVisible(false);
        break;
      case"Peterson":
        Trem1.setProtocolo("peterson");
        Trem2.setProtocolo("peterson");
        Trem1.setControladorProtocolo(1);
        Trem2.setControladorProtocolo(1);
        bandeira.setVisible(true);
        bandeira2.setVisible(true);
